...
TEST_CASE("Finding the leaf node containing a key", "[wBPTree]") {
  using wBPTreeType4 = wBPTree<int, int, 4, 4>;
  using wBPTreeType6 = wBPTree<int, int, 6, 6>;
  using wBPTreeType10  = wBPTree<int, int, 10, 10> ;
  using wBPTreeType12 = wBPTree<int, int, 12, 12>;
  using wBPTreeType20 = wBPTree<int, int, 20, 20>;

  struct root {
    pptr<wBPTreeType4> btree4;
    pptr<wBPTreeType6> btree3;
    pptr<wBPTreeType10> btree10;
    pptr<wBPTreeType12> btree12;
    pptr<wBPTreeType20> btree20;
  };
  ...
  if (!rootRef.btree10)
    transaction::run(pop, [&] { rootRef.btree10 = make_persistent<wBPTreeType10>(); });

  if (!rootRef.btree4)
    transaction::run(pop, [&] { rootRef.btree4 = make_persistent<wBPTreeType4>(); });

  if (!rootRef.btree3)
    transaction::run(pop, [&] { rootRef.btree3 = make_persistent<wBPTreeType6>(); });

  if (!rootRef.btree12)
    transaction::run(pop, [&] { rootRef.btree12 = make_persistent<wBPTreeType12>(); });

  if (!rootRef.btree20)
    transaction::run(pop, [&] { rootRef.btree20 = make_persistent<wBPTreeType20>(); });
  ...
  SECTION("Balancing two inner nodes from left to right") {
    ...
    std::array<pptr<wBPTreeType4::LeafNode>, 7> leafNodes = {
    ...
    node1Ref.search.get_rw().b.set(0);
    node1Ref.search.get_rw().b.set(1);
    node1Ref.search.get_rw().slot[1] = 0;
    node1Ref.search.get_rw().slot[2] = 1;
    node1Ref.search.get_rw().slot[0] = 2;
    ...
    node2Ref.search.get_rw().b.set(0);
    node2Ref.search.get_rw().b.set(1);
    node2Ref.search.get_rw().b.set(2);
    node2Ref.search.get_rw().b.set(3);
    node2Ref.search.get_rw().slot[1] = 0;
    node2Ref.search.get_rw().slot[2] = 1;
    node2Ref.search.get_rw().slot[3] = 2;
    node2Ref.search.get_rw().slot[4] = 3;
    node2Ref.search.get_rw().slot[0] = 4;

    node3Ref.keys.get_rw()[0] = 10;
    node3Ref.children.get_rw()[0] = leafNodes[5];
    node3Ref.children.get_rw()[4] = leafNodes[6];
    node3Ref.search.get_rw().b.set(0);
    node3Ref.search.get_rw().slot[1] = 0;
    node3Ref.search.get_rw().slot[0] = 1;
    ...
    REQUIRE(node1Ref.search.get_ro().slot[0] == 2);
    REQUIRE(node2Ref.search.get_ro().slot[0] == 2);
    REQUIRE(node3Ref.search.get_ro().slot[0] == 3);

    std::array<int, 2> expectedKeys1{{5, 20}};
    std::array<int, 2> expectedKeys2{{3, 4}};
    std::array<int, 3> expectedKeys3{{6, 8, 10}};

    std::array<pptr<wBPTreeType4::LeafNode>, 3> expectedChildren2 = {
      { leafNodes[0], leafNodes[1], leafNodes[2] }
    };
    std::array<pptr<wBPTreeType4::LeafNode>, 4> expectedChildren3 = {
    ...
    for (auto i = 1; i < 3; i++)
      node2Children[i-1] = node2Ref.children.get_ro()[node2Ref.search.get_ro().slot[i]].leaf;
    node2Children[2] = node2Ref.children.get_ro()[4].leaf;
    REQUIRE(std::equal(std::begin(expectedChildren2), std::end(expectedChildren2),
                       std::begin(node2Children)));

    std::array<pptr<wBPTreeType4::LeafNode>, 4> node3Children;
    for (auto i = 1; i < 4; i++)
      node3Children[i-1] = node3Ref.children.get_ro()[node3Ref.search.get_ro().slot[i]].leaf;
    node3Children[3] = node3Ref.children.get_ro()[4].leaf;
  ...
  SECTION("Balancing two inner nodes from right to left") {
    ...
    node1Ref.keys.get_rw()[1] = 20;
    node1Ref.children.get_rw()[0] = node2;
    node1Ref.children.get_rw()[4] = node3;
    node1Ref.search.get_rw().b.set(0);
    node1Ref.search.get_rw().b.set(1);
    node1Ref.search.get_rw().slot[1] = 0;
    node1Ref.search.get_rw().slot[2] = 1;
    ...
    node2Ref.search.get_rw().b.set(0);
    node2Ref.search.get_rw().slot[1] = 0;
    node2Ref.search.get_rw().slot[0] = 1;
    ...
    node3Ref.children.get_rw()[4] = leafNodes[6];
    node3Ref.search.get_rw().b.set(0);
    node3Ref.search.get_rw().b.set(1);
    node3Ref.search.get_rw().b.set(2);
    node3Ref.search.get_rw().b.set(3);
    node3Ref.search.get_rw().slot[1] = 0;
    node3Ref.search.get_rw().slot[2] = 1;
    node3Ref.search.get_rw().slot[3] = 2;
    node3Ref.search.get_rw().slot[4] = 3;
    node3Ref.search.get_rw().slot[0] = 4;
    ...
    REQUIRE(node1Ref.search.get_ro().slot[0] == 2);
    REQUIRE(node2Ref.search.get_ro().slot[0] == 3);
    REQUIRE(node3Ref.search.get_ro().slot[0] == 2);

    std::array<int, 2> expectedKeys1{{6, 20}};
    std::array<int, 3> expectedKeys2{{3, 4, 5}};
    std::array<int, 2> expectedKeys3{{7, 8}};

    std::array<pptr<wBPTreeType4::LeafNode>, 4> expectedChildren2 = {
      { leafNodes[0], leafNodes[1], leafNodes[2], leafNodes[3] }
    };
    std::array<pptr<wBPTreeType4::LeafNode>, 3> expectedChildren3 = {
    ...
    for (auto i = 1; i < 4; i++)
      node2Children[i-1] = node2Ref.children.get_ro()[node2Ref.search.get_ro().slot[i]].leaf;
    node2Children[3] = node2Ref.children.get_ro()[4].leaf;
    REQUIRE(std::equal(std::begin(expectedChildren2), std::end(expectedChildren2),
                       std::begin(node2Children)));

    std::array<pptr<wBPTreeType4::LeafNode>, 3> node3Children;
    for (auto i = 1; i < 3; i++)
      node3Children[i-1] = node3Ref.children.get_ro()[node3Ref.search.get_ro().slot[i]].leaf;
    node3Children[2] = node3Ref.children.get_ro()[4].leaf;
    REQUIRE(std::equal(std::begin(expectedChildren3), std::end(expectedChildren3),
                       std::begin(node3Children)));
  }
  ...
  SECTION("Handling of underflow at a inner node by rebalance") {
    auto &btree = *rootRef.btree4;
    std::array<pptr<wBPTreeType4::LeafNode>, 6> leafNodes = {
      { btree.newLeafNode(), btree.newLeafNode(), btree.newLeafNode(), btree.newLeafNode(),
        btree.newLeafNode(), btree.newLeafNode()}
    };

    std::array<pptr<wBPTreeType4::BranchNode>, 3> innerNodes = {
    ...
    auto &inner0Ref = *innerNodes[0];
    inner0Ref.keys.get_rw()[0] = 7;
    inner0Ref.children.get_rw()[0] = innerNodes[1];
    inner0Ref.children.get_rw()[4] = innerNodes[2];
    inner0Ref.search.get_rw().b.set(0);
    inner0Ref.search.get_rw().slot[1] = 0;
    inner0Ref.search.get_rw().slot[0] = 1;

    auto &inner1Ref = *innerNodes[1];
    inner1Ref.keys.get_rw()[0] = 5;
    inner1Ref.children.get_rw()[0] = leafNodes[0];
    inner1Ref.children.get_rw()[4] = leafNodes[1];
    inner1Ref.search.get_rw().b.set(0);
    inner1Ref.search.get_rw().slot[1] = 0;
    inner1Ref.search.get_rw().slot[0] = 1;

    auto &inner2Ref = *innerNodes[2];
    inner2Ref.keys.get_rw()[0] = 9;
    inner2Ref.keys.get_rw()[1] = 11;
    inner2Ref.keys.get_rw()[2] = 13;
    inner2Ref.children.get_rw()[0] = leafNodes[2];
    inner2Ref.children.get_rw()[1] = leafNodes[3];
    inner2Ref.children.get_rw()[2] = leafNodes[4];
    inner2Ref.children.get_rw()[4] = leafNodes[5];
    inner2Ref.search.get_rw().b.set(0);
    inner2Ref.search.get_rw().b.set(1);
    inner2Ref.search.get_rw().b.set(2);
    inner2Ref.search.get_rw().slot[1] = 0;
    inner2Ref.search.get_rw().slot[2] = 1;
    inner2Ref.search.get_rw().slot[3] = 2;
    inner2Ref.search.get_rw().slot[0] = 3;

    btree.underflowAtBranchLevel(innerNodes[0], 1, innerNodes[1]);

    REQUIRE(inner0Ref.search.get_ro().slot[0] == 1);
    REQUIRE(inner0Ref.keys.get_ro()[0] == 9);

    REQUIRE(inner1Ref.search.get_ro().slot[0] == 2);
    REQUIRE(inner2Ref.search.get_ro().slot[0] == 2);
  ...
  SECTION("Merging two inner nodes") {
    auto &btree = *rootRef.btree4;
    std::array<pptr<wBPTreeType4::LeafNode>, 5> leafNodes = {
      { btree.newLeafNode(), btree.newLeafNode(), btree.newLeafNode(), btree.newLeafNode(),
        btree.newLeafNode()}
    };
    ...
    node1Ref.search.get_rw().b.set(0);
    node1Ref.search.get_rw().slot[1] = 0;
    node1Ref.search.get_rw().slot[0] = 1;
    ...
    root1Ref.search.get_rw().b.set(0);
    root1Ref.search.get_rw().slot[1] = 0;
    root1Ref.search.get_rw().slot[0] = 1;
    ...
    REQUIRE(node1Ref.search.get_ro().slot[0] == 4);
    ...
    std::transform(std::begin(node1Ref.children.get_ro()), std::end(node1Ref.children.get_ro()),
                   std::begin(node1Children), [](wBPTreeType4::Node n) { return n.leaf; });
  ...
  SECTION("Merging two leaf nodes") {
    ...
    for (auto i = 0; i < 4; i++) {
      ...
      node1Ref.search.get_rw().slot[i+1] = i;
      node1Ref.search.get_rw().b.set(i);
    }
    node1Ref.search.get_rw().slot[0] = 4;

    for (auto i = 0; i < 4; i++) {
      node2Ref.keys.get_rw()[i] = i + 10;
      node2Ref.values.get_rw()[i] = i + 200;
      node2Ref.search.get_rw().slot[i+1] = i;
    ...
    REQUIRE(node1Ref.search.get_ro().slot[0] == 8);
  ...
  SECTION("Balancing two leaf nodes") {
    ...
    node1Ref.search.get_rw().slot[0] = 8;
    ...
    REQUIRE(node2Ref.search.get_ro().slot[0] == 6);
    REQUIRE(node1Ref.search.get_ro().slot[0] == 6);
  ...
  SECTION("Handling of underflow at a leaf node by merge and replace the root node") {
    ...
    parentRef.search.get_rw().b.set(0);
    parentRef.search.get_rw().slot[1] = 0;
    parentRef.search.get_rw().slot[0] = 1;
    btree.rootNode = parent;
    btree.depth = 1;

    btree.underflowAtLeafLevel(parent, 2, leaf2);
    REQUIRE(leaf1Ref.search.get_ro().slot[0] == 5);
  ...
  SECTION("Handling of underflow at a leaf node by merge") {
    ...
    parentRef.search.get_rw().b.set(0);
    parentRef.search.get_rw().b.set(1);
    parentRef.search.get_rw().slot[1] = 0;
    parentRef.search.get_rw().slot[2] = 1;
    parentRef.search.get_rw().slot[0] = 2;
    btree.rootNode = parent;

    btree.underflowAtLeafLevel(parent, 2, leaf2);
    REQUIRE(leaf1Ref.search.get_ro().slot[0] == 5);
    REQUIRE(btree.rootNode.branch == parent);
    REQUIRE(parentRef.search.get_ro().slot[0] == 1);
  }
  ...
  SECTION("Handling of underflow at a leaf node by rebalance") {
    ...
    btree.underflowAtLeafLevel(parent, 2, leaf2);
    REQUIRE(leaf1Ref.search.get_ro().slot[0] == 3);
  ...
  SECTION("Handling of underflow at a inner node") {
    ...
    inner1Ref.search.get_rw().b.set(0);
    inner1Ref.search.get_rw().b.set(1);
    inner1Ref.search.get_rw().slot[1] = 0;
    inner1Ref.search.get_rw().slot[2] = 1;
    ...
    REQUIRE(inner1Ref.search.get_ro().slot[0] == 4);
    std::array<int, 4> expectedKeys{{5, 15, 20, 30}};
    std::array<pptr<wBPTreeType4::LeafNode>, 5> expectedChildren{
      { leaf1, leaf2, leaf4, leaf5, leaf6 }
    };

    REQUIRE(std::equal(std::begin(expectedKeys), std::end(expectedKeys),
                       std::begin(inner1Ref.keys.get_ro())));
    std::array<pptr<wBPTreeType4::LeafNode>, 5> inner1Children;
    std::transform(std::begin(inner1Ref.children.get_ro()), std::end(inner1Ref.children.get_ro()),
                   std::begin(inner1Children), [](wBPTreeType4::Node n) { return n.leaf; });
  ...
  SECTION("Inserting an entry into a leaf node") {
    ...
    nodeRef.search.get_rw().slot[0] = 9;

    res = btree.insertInLeafNode(node, 5, 5000, &splitInfo);
    REQUIRE(res == false);
    REQUIRE(nodeRef.search.get_ro().slot[0] == 10);

    res = btree.insertInLeafNode(node, 1, 1, &splitInfo);
    REQUIRE(res == false);
    REQUIRE(nodeRef.search.get_ro().slot[0] == 11);
  ...
  SECTION("Inserting an entry into an inner node without a split") {
    ...
    nodeRef.search.get_rw().b.set(0);
    nodeRef.search.get_rw().slot[1] = 0;
  ...
  SECTION("Deleting an entry from a leaf node") {
    ...
    REQUIRE(nodeRef.search.get_ro().slot[0] == 8);
  ...
  SECTION("Constructing a B+ tree and iterating over it") {
    auto btree = rootRef.btree10;
    transaction::run(pop, [&] {
      if(btree) delete_persistent<wBPTreeType10>(btree);
      btree = make_persistent<wBPTreeType10>();
      auto &btreeRef = *btree;
      for (int i = 0; i < 50; i++) {
  ...
  /* Clean up */
  delete_persistent_atomic<wBPTreeType4>(rootRef.btree4);
  delete_persistent_atomic<wBPTreeType6>(rootRef.btree3);
  delete_persistent_atomic<wBPTreeType10>(rootRef.btree10);
  delete_persistent_atomic<wBPTreeType12>(rootRef.btree12);
  delete_persistent_atomic<wBPTreeType20>(rootRef.btree20);
